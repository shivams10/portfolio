...
export const Sidebar = () => {
  return (
    <div>
      ...
      />
      <h3 className="my-4 text-3xl font-medium text-purple-700 font-dmsans">
        Shivam Shukla
      </h3>
      <p className="p-2 my-3 bg-gray-200 rounded-full ">Web Developer</p>
      <a
        className="flex items-center justify-center p-2 my-3 bg-gray-200 rounded-full"
        href=""
        download="name"
      >
        <GiTie className="w-6 h-6" /> Download Resume
      </a>
      <div className="flex items-center justify-center w-9/12 gap-4 mx-auto my-5 text-purple-700 md:w-full">
      ...
      <button className="w-8/12 px-5 py-2 my-3 text-white rounded-full bg-gradient-to-r from-purple-500 to-indigo">
        Toggle Theme
      </button>
    </div>
  );
